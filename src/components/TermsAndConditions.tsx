    ...
    <div className={`font-sans py-6 text-neutral-300 ${className}`}>
      ...
      <div className="mb-2">
        <p className=" text-sm text-white">
          <span className=" text-white">1.</span> All quotes are prepared based on the client&apos;s specific travel plan and requirements.
        </p>
      </div>
      ...
      <div className="mb-2">
        <p className=" text-sm text-white">
          <span className=" text-white">2.</span> Total service time is calculated from the driver&apos;s departure from the parking lot until the driver returns to the same location.
        </p>
      </div>
      ...
      <div className="mb-2">
        <p className=" text-sm text-white">
          <span className=" text-white">3.</span> Overtime / Extra Distance: Each additional hour will be charged at $150, or each additional kilometre at $2, whichever threshold is reached first.
        </p>
      </div>
      ...
      <div className="mb-2">
        <p className=" text-sm text-white">
          <span className=" text-white">4.</span> Payment Methods: We accept online payments by debit card, credit card, PayPal or e-transfer. For other payment options, such as e-transfer or EFT, please contact{" "}
          <a 
      ...
      <div className="mb-2">
        <p className=" text-sm text-white">
          <span className=" text-white">5.</span> Please inform us promptly of any changes to your itinerary once a booking has been confirmed. To ensure smooth scheduling, we recommend finalizing your itinerary at least one week prior to the service date.
        </p>
      </div>
      ...
      <div className="mb-2">
        <p className=" text-sm mb-3 text-white">
          <span className=" text-white">6.</span> Refund Policy:
        </p>
        <ul className="ml-6 text-sm list-disc list-outside text-white">
          <li>
      ...
      <div className="mb-2">
        <p className=" text-sm text-white">
          <span className=" text-white">7.</span> Clients are responsible for maintaining the 
      ...
      <div className="mb-2">
        <p className=" text-sm text-white">
          <span className=" text-white">8.</span> Clients are liable for any damages to the vehicle 
      ...
      <div className="mb-2">
        <p className=" text-sm text-white">
          <span className=" text-white">9.</span> Leo Charter Services is not liable for delays 
      ...
      <div className="mb-2">
        <p className=" text-sm mb-3 text-white">
          <span className=" text-white">10.</span> Booking Cancellations by Leo Charter Services:
        </p>
        <p className=" text-sm mb-3 text-white">
          Leo Charter Services reserves the right to cancel a booking under certain circumstances, including 
          but not limited to:
        </p>
        <ul className="ml-6 space-y-2 text-sm list-disc list-outside text-white">
          <li className="">
      ...
      <div className="mb-2">
        <p className=" text-sm text-white">
          <span className=" text-white">11.</span> Consumption of alcohol on board requires prior 
      ...
      <div className="mb-2">
        <p className=" text-sm text-white">
          <span className=" text-white">12.</span> During peak seasons, vehicle availability and 
          rates are subject to daily change. Quotes are not guaranteed until a booking has been confirmed.
        </p>
      </div>

      {/* Footer */}
      <div className="mt-8 text-sm  mb-2 text-white">
