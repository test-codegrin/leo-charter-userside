...
export default function TermsAndConditionsM({ className = "" }: TermsAndConditionsProps) {
  return (
    <div className={`px-4 py-6 text-neutral-300 ${className}`}>
      {/* Section 1 */}
      <div className="mb-6">
      ...
      <div className="mb-6">
        ...
        <ul className="ml-6 space-y-2 text-sm list-disc list-outside">
